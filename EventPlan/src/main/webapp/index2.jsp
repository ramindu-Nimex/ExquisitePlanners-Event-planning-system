	...
	<nav class="navT" id="navT">
		<div class="navTmenu container" id="navT-menu">
			...
			<ul class="navTlist">
				...
				<li class="navTitem"><a href="packageView.jsp"
				...
				<li class="navTitem"><a
					href="IT22603418/IT22603418_FeedBack.jsp"
	...
	<main class="mainT" id="mainT">
		...
		<section class="sectionT container sectionTheight" id="packages">
			...
			<div class="containerA">
				<a href="IT22603418/IT22603418_insertReserve.jsp"> <input
					type="button" name="Reserve" value="Request Reservation"
					class="btnA">
				</a>
			</div>
		</section>
					...
					<div class="about-img">
						...
						<form action="IT22603418/IT22603418_ContactUs.jsp" method="post">
							<input type="submit" value="Contact Us"
								style="font-size: 25px; padding: 5px; color: black; background-color: white; left: 20px; border-radius: 0.5rem">
						</form>
					</div>
					<div class="containt">
